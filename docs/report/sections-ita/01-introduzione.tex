...
\begin{itemize}
    \item Framework: Spring Boot 3.2.x
...
\subsubsection{1. Esclusione Strategica Lombok}

Il codice generato da Lombok (getter, setter, equals, hashCode) è stato escluso dal mutation testing, concentrando l'analisi sulla logica di business effettiva. Questa scelta è giustificata da:

\begin{itemize}
    \item \textbf{Validità accademica}: Il mutation testing deve misurare il codice scritto dagli sviluppatori
    \item \textbf{Efficienza pratica}: Lombok genera pattern standard e provati
    \item \textbf{Allineamento industriale}: Aziende come Netflix ed Amazon escludono il codice auto-generato
\end{itemize}
